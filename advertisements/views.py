...
from advertisements.permissions import IsNotOwner, IsOwnerOrIsStaffOrReadOnly
...
class AdvertisementViewSet(ModelViewSet, ManageFavorite):
    ...
    #         serializer.validate(data=validated_data)
    #         serializer.create(validated_data)
    #         return Response('The Advertisement delete to Favorites ', status=status.HTTP_201_CREATED)
    #     return Response('The Advertisement missing in database', status=status.HTTP_204_NO_CONTENT)
